...
<div class="row">
	<div class="box">
	   <div class="col">
          <hr> <h2 class="intro-text text-center">
          	      <strong> Historique des flux</strong>
               </h2> <hr>  <br>
	...
	<div class="row">
          	<div class="box">
      			...
      			<div class="col-lg-3"> 
					<span id="btn-batview"> <button class="btn btn-lg btn-block" onclick="current_view = 'bat'; updateCharts()"> Affichage par batiment</button> </span>
		   		</div>
      			<div class="col-lg-3"> 
					<span id="btn-fluxview"> <button  class="btn btn-lg btn-block" onclick="current_view = 'flux' ; updateCharts()"> Affichage par flux</button> </span>
		   		</div>
