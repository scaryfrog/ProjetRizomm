...
<script type="text/javascript" src="public/js/charts_byID.js"></script> 

<div class="row">
	<div class="box">
	   <div class="col">
          <hr> <h2 class="intro-text text-center">
          	      <strong> Historique des flux par ID</strong>
               </h2> <hr>  <br>
...
<!--
	<div class="row">
        ...
        <div class="col-lg-6">
            <div class="input-group-addon"> Flux selectionnés </div>
            <div id="flux_group_select" onchange="updateFilter(this)" >
